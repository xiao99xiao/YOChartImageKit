...
enum YOChart {
    ...
    func drawImage(frame: CGRect, scale: CGFloat) -> Any {
        ...
        case .VerticalBarChart:
            ...
            image.values = (0..<15).map { _ in NSNumber(value: arc4random_uniform(50) + 1) }
            return image.draw(frame, scale: scale)
        case .HorizontalBarChart:
            ...
            image.values = (0..<8).map { _ in NSNumber(value: arc4random_uniform(50) + 1) }
            return image.draw(frame, scale: scale)
        case .DonutChart:
        ...
        case .SmoothLineChartGradient:
            ...
            image.strokeColor = UIColor.white
            image.gradientFill = true
            image.firstGradientColor = UIColor.white
            image.secondGradientColor = randomColor()
            image.values = (0...10).map { _ in NSNumber(value: arc4random_uniform(8)) }
            image.smooth = true
            return image.draw(frame, scale: scale)
        case .VerticalBarChartGradient:
            ...
            image.positiveColor = UIColor.white
            image.positiveGradientColor = UIColor.green
            image.negativeColor = UIColor.white
            image.negativeGradientColor = UIColor.red
        ...
        case .AnimatedDonutChart:
            ...
            image.animationBackgroundColor = UIColor.darkGray
